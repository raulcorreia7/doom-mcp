...
implemented. DMCP copies the pixels immediately. Console and cheat-style tools
are enabled by default; restricted embeds can set the permission fields on
`cfg.base.permissions` to `false`.
