...
// 
// This provides a common interface for different JSON libraries.
// Currently supported:
//   - yyjson (default, fastest)
//   - nlohmann/json (for compatibility)
//   - RapidJSON (for speed comparison)
// ============================================================================
...
public:
  ...
  // Move-only - defined in implementation due to unique_ptr with incomplete type
  Builder(Builder&&);
...
// Helper Functions
// ============================================================================
inline std::string make_jsonrpc_response(std::string_view id, 
...
inline std::string make_jsonrpc_error(std::string_view id,
                                       int code,
